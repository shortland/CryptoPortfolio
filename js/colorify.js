    ...
    setTimeout(function(){
      ...
      function isLoaded(el, pos){
        ...
        if(_GRADIENT) {
          ...
          var gradient = 'rgba('+rgb[0].r+','+rgb[0].g+','+rgb[0].b+', '+opacity+'), rgb('+rgb[1].r+','+rgb[1].g+','+rgb[1].b+')';
          el.parentNode.style.backgroundImage = 'linear-gradient('+_GRADIENT_DIR+','+gradient+') ';
        }
        else{
          el.parentNode.style.backgroundColor = 'rgba('+rgb[0].r+','+rgb[0].g+','+rgb[0].b+', '+opacity+')';
        }
        ...
        if(!_GIVE==false) {
          ...
          if (tar == '#' || tar == "." || tar == '*' || tar == "["){
            ...
            for(var i = 0, len = to.length; i < len; i++) {
             to[i].setAttribute('style', _PROPERTY + ': rgba('+rgb[0].r+','+rgb[0].g+','+rgb[0].b+', '+opacity+')');
            }
          }
          if(_TARGET=='parent') {
            el.parentNode.parentNode.setAttribute('style', _PROPERTY + ': rgba('+rgb[0].r+','+rgb[0].g+','+rgb[0].b+', '+opacity+') !important');
          }
          if(_TARGET=='child') {
           el.childNode.setAttribute('style', _PROPERTY + ': rgba('+rgb[0].r+','+rgb[0].g+','+rgb[0].b+', '+opacity+') !important');
          }
        }
